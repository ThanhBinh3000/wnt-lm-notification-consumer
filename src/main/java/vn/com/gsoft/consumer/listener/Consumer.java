...
public class Consumer {
    ...
    @KafkaListener(topics = "#{'${wnt.kafka.internal.producer.topic.notification}'}", groupId = "#{'${wnt.kafka.internal.consumer.group-id}'}", containerFactory = "kafkaInternalListenerContainerFactory")
